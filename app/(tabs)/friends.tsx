  ...
  return (
    <View className='flex-1 items-center justify-center bg-black'>
      <View className='absolute top-16 left-0 right-0 z-10'>
        <Header title='Friends' color='white'/>
      </View>
      <FlatList 
        data={videos}
        ...
        ListEmptyComponent={
          <View className='flex-1 h-screen items-center justify-center bg-black'>
            <Ionicons name='sad' size={48} color={"white"}/>
            <Text className='text-white text-3xl'>No Videos Found</Text>
          </View>
        }
      />
    </View>
